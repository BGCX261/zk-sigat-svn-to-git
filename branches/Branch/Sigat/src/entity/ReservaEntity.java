...
public class ReservaEntity implements Serializable {
    ...
    @ManyToMany(mappedBy = "reservasList")
    private List<PasajeroEntity> pasajerosList;
    @JoinColumn(name = "clientes_idclientes", referencedColumnName = "idclientes")
    @ManyToOne
    private ClienteEntity clientesIdclientes;
    ...
    @XmlTransient
    public List<PasajeroEntity> getPasajerosList() {
        return pasajerosList;
    }

    public void setPasajerosList(List<PasajeroEntity> pasajerosList) {
        this.pasajerosList = pasajerosList;
    }

    public ClienteEntity getClientesIdclientes() {
        return clientesIdclientes;
    }

    public void setClientesIdclientes(ClienteEntity clientesIdclientes) {

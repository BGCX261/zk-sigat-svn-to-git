...
public class ReservaDAO {
	...
	public List selectAll() {
		...
		try {
			...
			for (Iterator iterator = tblNList.iterator(); iterator.hasNext();) {
				...
				ni.setNombre(tblnewsiteration.getNombre());
				ni.setNombreContacto(tblnewsiteration.getNombreContacto());
				ni.setDireccion(tblnewsiteration.getDireccion());
				ni.setTelefono(tblnewsiteration.getTelefono());
	...
	public boolean updateNewsItem(ReservasItem ni) {
		...
		try {
			...
			reservaEntity.setNombre(ni.getNombre());
			reservaEntity.setNombreContacto(ni.getNombreContacto());
			reservaEntity.setDireccion(ni.getDireccion());
			reservaEntity.setTelefono(ni.getTelefono());

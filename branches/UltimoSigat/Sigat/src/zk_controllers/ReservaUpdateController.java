...
public class ReservaUpdateController extends GenericForwardComposer {
	...
	public void prepareWindow(int left, int top, ReservasItem ni) {
		...
		ClienteEntity cliente= clienteResController.findClientes(ni.getIDCliente());
	...
	public void onClick$btnUpdateNews() {	
		...
		ni.setContent("Anticipo: "+ni.getAdelanto()+", "+ni.getNombreContacto() +", "+ nameText.getText() +" - "+ ni.getDepto());
		ni.setLocked(false);

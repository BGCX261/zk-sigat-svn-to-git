...
/**
 * Clase que formatea los items de reserva
 * 
 * @author Sebastian
 * 
 */
public class ReservasItem extends SimpleCalendarEvent {
	...
	// Carga datos en tabla pasajeros reserva
	public void setIdPasajeros(int[] iDpasejero) {
		this.iDpasajeros = iDpasejero;

	}

	public int[] getIdPasajeros() {
		return this.iDpasajeros;
	}
}
